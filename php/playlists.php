...
// ARTISTS
if ($stmt = $con->prepare("SELECT searchinfo.track_id,searchinfo.artist_id,searchinfo.track_title,track_likes_details.total_likes,searchinfo.album_name,searchinfo.artist_name,searchinfo.track_loc,searchinfo.album_loc,searchinfo.artist_loc FROM track_likes_details RIGHT OUTER JOIN searchinfo on track_likes_details.track_id = searchinfo.track_id")) {
    $stmt->execute();
